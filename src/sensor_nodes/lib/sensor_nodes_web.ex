defmodule SensorNodesWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SensorNodesWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/sensor_nodes_web/templates",
                        namespace: SensorNodesWeb
